...
function hideAchievement() {
	...
	setTimeout(function () {achievementElement.classList.add("hide");},5000); // Note that this interval matches the timing of CSS animation
}
	...
	if (document.getElementById("stone").value >= 3) {
		if (document.getElementById("sticks").value >= 2) {
			if (document.getElementById("woodPick").value == 0) {
				g = g - 2;
				document.getElementById("stone").value = document.getElementById("stone").value - 3;
				h = h + 1;
				best_pick = "stone";
				document.getElementById("sticks").value = g;
...
function mineBlock() {
	...
	if (document.getElementById("Durability").value > 0) {
		...
		document.getElementById("Durability").value = document.getElementById("Durability").value - 1;
		check();
		
		if (stone_pick == 0 && stone >= 3) {
			stone_pick = 1;
			document.getElementById("makeWoodPick").innerHTML= "Craft Stone Pickaxe - Cost: 2 Sticks, 3 Cobblestone";
